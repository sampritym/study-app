...
const NewPostModal = (props) => {
  ...
  return (
    <div className="new-post-modal">
      ...
      {contentType === "image" && (
        <input type="file" accept="image/*" onChange={(e) => handlePostContentChange(e.target.files[0])} />
      )}
      {contentType === "video" && (
        <input type="text" placeholder="Paste video embed code..." value={postContent} onChange={(e) => handlePostContentChange(e.target.value)} />
      )}
      {contentType === "link" && (
        <div>
          <input type="text" placeholder="Link URL..." value={postContent} onChange={(e) => handlePostContentChange(e.target.value)} />
